    ...
    <section className="bg-white px-6 md:px-16 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        {/* <div className="flex items-center gap-2 mt-2 text-purple-800 text-sm">
          ...
          <span>info@snapem.org</span>
        </div> */}
        <a
          href="https://mail.google.com/mail/?view=cm&to=info@snapem.org"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 mt-2 text-purple-800 text-sm hover:underline"
        >
          <FiMail className="text-purple-700" size={16} />
          <span>info@snapem.org</span>
        </a>
