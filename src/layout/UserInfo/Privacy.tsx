  ...
  return (
    <section className="bg-white px-6 md:px-16 py-12 text-gray-800">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Section Title */}
        <p className="text-sm text-purple-800 font-semibold mb-1">Privacy Policy</p>
        <h2 className="text-2xl text-purple-900 md:text-3xl font-bold mb-4">
          Protecting Your Data Every Step of the Way
        </h2>

        {/* Intro Paragraph */}
        <p className="mb-6 text-sm text-purple-800 md:text-base">
        ...
        {/* Info We Collect */}
        <h3 className="font-semibold text-purple-900 mb-2">Information We Collect</h3>
        <ul className="list-disc pl-5 text-purple-700 text-sm mb-6 space-y-1">
        ...
        <p className="text-sm mb-2 text-purple-600">Your data is used strictly for the following purposes:</p>
        <ul className="list-disc pl-5 text-purple-700 text-sm mb-6 space-y-1">
        ...
        {/* Data Storage */}
        <h3 className="text-purple-900 font-semibold mb-2">Data Storage and Security</h3>
