  ...
  return (
    <div className="sticky top-0 z-50 bg-transparent text-white">
      ...
      >
        ...
        <ul
          className={`
    transition-all duration-300 ease-in-out transform md:transform-none
    md:flex md:space-x-4 md:static md:w-auto md:opacity-100 md:translate-y-0 md:pointer-events-auto
    ${
      showMenu
        ? 'block opacity-100 translate-y-0'
        : 'hidden opacity-0 -translate-y-4 pointer-events-none'
    }
    absolute top-16 left-0 w-full bg-white border-t border-gray-200 md:bg-transparent md:border-0
  `}
          style={{ zIndex: 100 }}
        >
          <li
          ...
          >
            <Link
              to={!isAuthenticated ? '/home' : '/user-home'}
          ...
          {!isAuthenticated ? (
            ...
            <>
              ...
              >
                <Link to={'/subscription'} onClick={() => setShowMenu(false)}>
                  {' '}
                  Subscription
                </Link>
              </li>
              ...
              <li className="p-1">
                <button
                  ...
                  className="bg-purple-950 text-white px-2 py-1.5 rounded-lg hover:bg-purple-980"
                >
                  Logout
                </button>
              </li>
