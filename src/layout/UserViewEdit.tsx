...
export default function UserViewEdit() {
  ...
  return (
    <>
      <PageMeta
        title="Snap'em Profile Dashboard | TailAdmin - Next.js Admin Dashboard Template"
        description="This is snap'em Profile Dashboard page for snap'em - React.js Tailwind CSS Admin Dashboard Template"
      />
