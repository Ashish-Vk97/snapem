...
export default function SmsOpt() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!validatePhone(phone)) {
      setError("Enter a valid phone number in E.164 format (e.g. +12025550100).");
      return;
    }
    if (!smsConsent) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-start">
            ...
            <label className="ml-2 text-sm text-gray-700">
              You agree to receive automated transactional messages. Message frequency may vary.
              Standard message & data rates may apply. Reply STOP to opt out, HELP for help.
