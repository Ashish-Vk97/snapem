...
import { hitGetAllUsers } from "../../service/user.service";
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row items-center justify-between space-y-2S md:space-y-0 md:space-x-1 p-4">
        ...
        <div>
        <button  type="button" className=" bg-purple-700 flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                        <PlusIcon />
                        Add Users
                    </button>
                    ...
                    users.map((order) => (
                      <TableRow key={order?._id}>
                        ...
                        <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                          ...
                          >
                            <svg
                              onClick={() => navigate(`users/view-edit-profile/${order?._id}`)}
                            ...
                            &nbsp;
                            <svg
                              onClick={() => navigate(`/view-edit-profile/${order?._id}`)}
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                              viewBox="0 0 24 24"
                              strokeWidth={2}
