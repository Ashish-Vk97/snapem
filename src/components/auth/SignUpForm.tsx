...
if (name === "country" || name === "state" || name === "city" || name === "pincode") {
 ...
 const submitHandler = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!signUpData.name || !signUpData.email || !signUpData.password || !signUpData.phone || !signUpData.gender) {
       ...
       console.log(data,"token11111....");
       if (data.status ) {
      
       // localStorage.setItem("USER", JSON.stringify({_id,email,role,name}));
        // setCurrentUser(()=>({  _id,email,role,name }));
